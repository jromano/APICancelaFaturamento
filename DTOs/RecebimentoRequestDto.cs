...
public class GridCancelarDto
{
    public string? Valor { get; set; }
    public string? Competencia { get; set; }
    public string? NumeroRecibo { get; set; }
    public string? DataVencimentoRecibo { get; set; }
    public string? TipoFaturamento1 { get; set; }
    public string? TipoFaturamento2 { get; set; }
}

public class TodosAnexosDto
{
